...
describe('AvlTree', () => {
  ...
  it('AvlTree remove node', () => {
    ...
    expect(tree.toPreOrderString()).toBe('9,5,3,2,4,7,6,8,12,11,10,13'); // toString2 is preOrder

    tree.insert(1);
    expect(tree.toPreOrderString()).toBe('9,5,3,2,1,4,7,6,8,12,11,10,13');
    tree.insert(0);
    expect(tree.toPreOrderString()).toBe('9,5,3,1,0,2,4,7,6,8,12,11,10,13');

    tree.remove(13);
    // expect(tree.toString2()).toBe('9,5,3,1,0,2,4,7,6,8,12,11,10'); // now
    expect(tree.toPreOrderString()).toBe('5,3,1,0,2,4,9,7,6,8,11,10,12'); // correct
  });
});
